...
public class TestData {
    ...
    public static final LocalDateTime futureStartTime = LocalDateTime.now().plusHours(1).truncatedTo(ChronoUnit.SECONDS);
    public static final LocalDateTime futureEndTime = LocalDateTime.now().plusHours(2).truncatedTo(ChronoUnit.SECONDS);
    public static final LocalDateTime currentDateTime = LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS);
    public static final LocalDateTime pastStartTime = LocalDateTime.now().minusHours(2).truncatedTo(ChronoUnit.SECONDS);
    public static final LocalDateTime pastEndTime = LocalDateTime.now().minusHours(1).truncatedTo(ChronoUnit.SECONDS);
